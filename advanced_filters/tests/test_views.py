...
class TestGetOperatorChoices(TestCase):
    ...
    def setUp(self):
        self.user = factories.SalesRep()
        assert self.client.login(username='user', password='test')
        self.options = dict(AdvancedFilterQueryForm.OPERATORS)
    ...
    def test_field_with_choices(self):
        ...
        self.assert_json(res, {
            ...
            {
                'key': 'iexact',
                'value': self.options['iexact']
            },
            {
                'key': 'icontains',
                'value': self.options['icontains']
            },
            {
                'key': 'iregex',
                'value': self.options['iregex']
            },
            {
                'key': 'isnull',
                'value': self.options['isnull']
            },]
        })
    ...
    def test_boolean_field(self):
        ...
        self.assert_json(res, {
            'results': [{
                'key': 'istrue',
                'value': self.options['istrue']
            },
            {
                'key': 'isfalse',
                'value': self.options['isfalse']
            },
            {
                'key': 'isnull',
                'value': self.options['isnull']
    ...
    def test_datetime_field(self):
        ...
        self.assert_json(res, {
            ...
            {
                'key': 'lt',
                'value': self.options['lt']
            },
            {
                'key': 'gt',
                'value': self.options['gt']
            },
            {
                'key': 'lte',
                'value': self.options['lte']
            },
            {
                'key': 'gte',
                'value': self.options['gte']
            },
            {
                'key': 'isnull',
                'value': self.options['isnull']
